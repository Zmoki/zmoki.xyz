...
import ResourceExhibitionMyInstallation from "@/images/photo-resource-exhibition-zarema-installation-prints-limassol-cyprus.jpg";
import AqiInTbilisiScreenshot from "@/images/screenshot-aqi-in-tbilisi-nov-30-2025.png";
...
I [moved to Tbilisi from Limassol](/feed/1-about-me/#places-that-shaped-me), Cyprus, in 2024, where I settled in spring 2022, having moved there from St. Petersburg, Russia.
...
<InProse aside>
  Now I'm planning [my next exhibition, in
  Tbilisi](/feed/9-next-exhibition-deadline-map-tbilisi-art-spaces/). A symbolic March 2026 deadline
  set the plan and pushed me to map the city's art spaces.
</InProse>

<PostImage
  src={ResourceExhibitionMyInstallation}
  alt="Installation view from RE:SOURCE group exhibition showing The Blue artwork of Zarema Khalilova displayed on a stone wall in Limassol, Cyprus"
>
  My installation from "RE:SOURCE" group exhibition, 17-21 May 2024, Limassol, Cyprus. "The Blue"
  artwork. I searched for months for a clear sky, but even this one contains dust particles.
</PostImage>
...
<PostImage
  ...
  alt="Screenshot of aqi.in website showing real-time air quality data for Tbilisi, Georgia, displaying AQI 105 (Poor), with PM10 and PM2.5 levels, weather information, and a map with air quality markers"
>
  Air quality in Tbilisi on November 30th 2025 on aqi.in showing AQI 105 (Poor), with PM10 at 52
  &micro;g/m<sup>3</sup> and PM2.5 at 37 &micro;g/m<sup>3</sup>
</PostImage>
...
<InProse aside>
  My scarf and most of my warm wardrobe came from Tbilisi swaps. Here's [my story and guide to the
  swap scene](/feed/6-tbilisi-swaps-guide/).
</InProse>
