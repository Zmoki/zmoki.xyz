...
<figure class="flex w-full flex-col items-center">
  <Image
    ...
    alt="Installation view from RE:SOURCE group exhibition showing The Blue artwork of Zarema Khalilova on the left and small photo prints on the right, displayed on a stone wall in Limassol, Cyprus"
    widths={[600, 900, 1200]}
...
<figure class="flex w-full flex-col items-center">
  <Image
    ...
    loading="lazy"
    class="max-w-full rounded-lg border-2 border-solid border-slate-200 shadow-lg"
  />
  <figcaption class="!mt-0 text-center text-sm text-gray-500">
