...
<InProse aside>
  Tbilisi also has a vibrant art scene. I want to exhibit my collages here, so I built [a map of 20+
  Tbilisi art spaces](/feed/9-tbilisi-art-scene-map/) and set out to visit galleries one pin at a
  time.
</InProse>
