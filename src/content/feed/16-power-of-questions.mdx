...
<PostImage src={MilanoteBoard} alt="A Milanote research board titled 'questions', showing notes on what a question is, auxiliary verbs, modality, Yes/No questions, and interrogative questions.">
