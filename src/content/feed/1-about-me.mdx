...
import ImageZaremaMoscowJS from "@/images/photo-zarema-on-stage-moscowjs-50-2021.jpg";
import ImageMisha from "@/images/photo-cat-misha.jpeg";
import ImageFirstExhibitionLayout from "@/images/photo-zarema-first-exhibition-layout.jpg";
...
<InProse aside>
  <PostImage
    src={ImageZaremaMoscowJS}
    alt="Photo of Zarema Khalilova on stage at MoscowJS 50 event in 2021 during the talk 'So what next?'"
  >
    Me on stage at [MoscowJS 50](https://habr.com/ru/companies/moscowjs/articles/582012/) event in
    2021 with the talk "So what next?" about my career and art.
  </PostImage>
</InProse>

I am a:

- **Fractional Marketing Engineer** with over 20 years of engineering experience.
...
<InProse aside>
  <PostImage src={ImageMisha} alt="Photo of Zarema Khalilova's cat Misha">
    Misha, my cat.
  </PostImage>
</InProse>
...
- I poured my energy into community, building **[SPB Frontend](https://spb-frontend.ru/)** into the big local meetup and helping launch the **[HolyJS](https://holyjs.ru/en/)** conference.

Now, after all that, I feel the pull again. I want to build my own path.

## My art and collecting

In 2021, I started collecting contemporary art.

<InProse aside>
  <PostImage
    src={ImageFirstExhibitionLayout}
    alt="Photo of Zarema Khalilova's first exhibition layout"
  >
    My first exhibition layout.
  </PostImage>
</InProse>

Inspired by the book _A Poor Collector's Guide to Buying Great Art_ by Erling Kagge, I began my collection by acquiring pieces directly from living artists, galleries, and at art auctions, first focusing on Russian artists, then Cypriot and Greek.
