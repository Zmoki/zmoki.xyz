            ...
            if (codeNode) {
              ...
              const copyButton = {
                ...
                properties: {
                  type: "button",
                  class:
                    "absolute top-2 right-2 px-3 py-1.5 text-xs font-medium font-mono uppercase tracking-normal rounded-sm bg-zmoki-jade-500 text-white hover:bg-zmoki-jade-500/80 focus:outline-none focus:ring-2 focus:ring-zmoki-azure-500 focus:ring-offset-2 transition-colors duration-200",
